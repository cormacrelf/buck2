...
impl DiskStateOptions {
    pub fn new(
        ...
        let sqlite_materializer_state = matches!(
            ...
            .parse::<RolloutPercentage>(BuckconfigKeyRef::new("buck2", "sqlite_materializer_state"))?
...
fn sqlite_db_setup_metadata_and_versions(
    ...
    if let Some(buckconfig_version) = root_config.parse(BuckconfigKeyRef::new("buck2", version_config))? {
